...
readonly APP="$BUILD_ROOT/Codex Update Helper.app"
...
/bin/cp "$PROJECT_ROOT/bin/codex-update-helper" "$APP/Contents/Resources/codex-update-helper"
/bin/chmod 755 "$APP/Contents/Resources/codex-update-helper"
...
<key>CFBundleName</key><string>Codex Update Helper</string>
<key>CFBundleDisplayName</key><string>Codex Update Helper</string>
